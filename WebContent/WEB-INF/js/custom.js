...
// toggle function
	$('a.trigger').click(function(){
		if( ! $(this).hasClass('active')){
			...
			$('#container').append('<div class="text">用科技感知水利&nbsp;共建人水和谐</div>').show('slow');
		} else {
		$("#totoggle").slideToggle("slow");
...
// from home to info
	function infopage() {
		if  ($("#infopage").is(":hidden")) {
				...
				$("a.info").css({"background":"url(style/images/home.png) no-repeat scroll 0 0"});
				$("a.contact").css({"background":"url(style/images/home.png) no-repeat scroll 0 0"});
				$("#homepage").animate({height: "toggle", opacity: "toggle"}, "slow" );
				$("#infopage").animate({height: "toggle", opacity: "toggle"}, "slow" );
			}
			else {
				$("a.info").css({"background":"url(style/images/info.png) no-repeat scroll 0 0"});
				$("a.contact").css({"background":"url(style/images/contact.png) no-repeat scroll 0 0"});
				$("#infopage").animate({height: "toggle", opacity: "toggle"}, "slow" );
				$("#homepage").animate({height: "toggle", opacity: "toggle"}, "slow" );
			}
		}
...
$(document).ready( function(){
	...
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'style/images/homephoto/2.png', thumb : 'style/images/homephoto/2-2.png', url : ''},
											{image : 'style/images/homephoto/4.png', thumb : 'style/images/homephoto/4-4.png', url : ''},
											{image : 'style/images/homephoto/8.png', thumb : 'style/images/homephoto/8-8.png', url : ''},
											{image : 'style/images/homephoto/7.png', thumb : 'style/images/homephoto/7-7.png', url : ''},
											{image : 'style/images/homephoto/13.png', thumb : 'style/images/homephoto/13-13.png', url : ''}
									]
	});
});
